function header() {
    ...
    if (window.innerWidth <= 600) {
        ...
        document.getElementById("m2").style.marginLeft = "0";
...
function scrooo() {
    document.getElementById('m2').scrollIntoView({
        behavior: 'smooth'
    });
}
...
function the() {
    if (theam) {
        ...
        document.getElementById("tit3").className = "tit-light";
        document.getElementById("tit4").className = "tit-light";
        ...
        document.getElementById("tit4").className = "tit";
